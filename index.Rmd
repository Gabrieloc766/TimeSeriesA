...
# Graficar la descomposición
plot(descomposicion2, main = "Descomposición TS DIFERENCIADA")
...
SEGUN EL AUTOARIMA DEBERIAMOS ELIMINAR seasonal = c(1, 1, 0) ya que no se especifica una componente estacional en el modelo seleccionado por auto.arima.

LO MALO ES QUE SI LO CAMBIAMOS, SEGURO CAMBIE EL RESULTADO. Y NOS TOQUE AJUSTAR ANÁLISIS
